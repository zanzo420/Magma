 ...
 * <p>
 * Plugs in our custom {@link ClosingUndertowWebSocketHandlerAdapter}, as well as uses a shared buffer-pool to avoid
 * leaks. Leaks happen due to the {@link DefaultByteBufferPool} using a thread-local variable that holds a reference to
 ...
 *
 * <p>Rest of the file is copied from the superclass(es) that is necessary to make that work.
 */
